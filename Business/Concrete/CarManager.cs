...
namespace Business.Concrete
{
    public class CarManager : ICarService
    {
        ...
        public IDataResult<List<CarDetailDto>> GetByFilters(int brandId, int carId)
        {
            return new SuccessDataResult<List<CarDetailDto>>(_carDal.GetByFilters(brandId, carId));
        }
    }
}
